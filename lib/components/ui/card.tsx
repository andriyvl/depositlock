...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.875rem] border border-border/60 bg-card/92 text-card-foreground shadow-card backdrop-blur-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-primary text-[1.625rem] font-bold leading-tight tracking-[-0.03em]",
      className,
    )}
    {...props}
  />
